...
> = {
	regular: {
		ring: 'ring-blue-500',
		hover: 'hover:border-blue-400/60 hover:bg-blue-50/40 dark:hover:bg-blue-950/20',
	...
	vip: {
		ring: 'ring-amber-500',
		hover: 'hover:border-amber-400/60 hover:bg-amber-50/40 dark:hover:bg-amber-950/20',
	...
	vvip: {
		...
		hover: 'hover:border-fuchsia-400/60 hover:bg-fuchsia-50/40 dark:hover:bg-fuchsia-950/20',
		...
		<div className="mx-auto max-w-3xl px-6 py-10">
			<header className="mb-6">
				...
				<p className="text-muted-foreground mt-2">
					Pilih jenis tiket, isi data diri terus lanjutin ke
					pembayaran
				</p>
			</header>
			...
			<form
					...
					{turnstileSiteKey ? (
						<div className="flex flex-col gap-2">
							...
							{turnstileError ? (
								...
								<p className="text-xs text-muted-foreground">
									Selesaikan tantangan Turnstile untuk
						...
						<p className="text-xs text-destructive">
							Turnstile site key is missing. Ask an admin to
				...
				<div className="flex items-center justify-end gap-3">
					...
					<Button
						...
						className="min-w-32"
						disabled={
							!isFormValid || total <= 0 || isLoading || !isHuman
						}>
			...
			<Dialog
				...
				<DialogContent>
					<DialogHeader>
						...
						<DialogDescription>
							Your ticket has been reserved. Review the details
							below.
						</DialogDescription>
					</DialogHeader>
