      ...
      <Table>
        ...
        <TableBody>
          {pageRows.map((c: Customer) => (
            <TableRow key={c.id}>
              <TableCell className="font-mono">{shortId(c.id, 2)}</TableCell>
              <TableCell>{c.name}</TableCell>
              <TableCell className="hidden md:table-cell">{c.email}</TableCell>
              <TableCell className="hidden md:table-cell">{c.nim}</TableCell>
    ...
    <div>
      ...
      <Table>
        ...
        <TableBody>
          {pageRows.map((o) => (
            <TableRow key={o.id}>
              <TableCell className="font-mono">{shortId(o.id, 2)}</TableCell>
              <TableCell>
              ...
              <TableCell>
                <StatusBadge label={o.status} tone={toneForOrder(o.status)} />
              </TableCell>
              <TableCell className="hidden md:table-cell">
    ...
    <div>
      ...
      <Table>
        ...
        <TableBody>
          {pageRows.map((t) => (
            <TableRow key={t.id}>
              <TableCell className="font-mono">{shortId(t.id, 2)}</TableCell>
              <TableCell className="hidden md:table-cell">
                <div className="grid size-10 place-items-center rounded bg-muted font-mono text-[10px]">
                  {shortUuid(t.ticket_code)}
                </div>
              </TableCell>
              <TableCell className="font-mono">{t.ticket_code}</TableCell>
              <TableCell className="hidden md:table-cell">
                {t.event_name}
              </TableCell>
              <TableCell>
                <StatusBadge label={t.status} tone={toneForTicket(t.status)} />
              </TableCell>
              <TableCell className="hidden md:table-cell">
    ...
    <div>
      ...
      <Table>
        ...
        <TableBody>
          {pageRows.map((e) => (
            <TableRow key={e.id}>
              <TableCell className="font-mono">{shortId(e.id, 2)}</TableCell>
              <TableCell>{e.name}</TableCell>
              <TableCell className="hidden md:table-cell">
                {formatDateTime(e.starts_at)}
              </TableCell>
              <TableCell className="hidden md:table-cell">{e.venue}</TableCell>
              <TableCell className="text-right">
                <div className="flex justify-end gap-2">
                  <Button size="sm" variant="outline" disabled>
                    View
